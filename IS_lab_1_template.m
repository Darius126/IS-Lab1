...
w1 = w1 + n*abs(e1)*x1(1)+ n*abs(e2)*x1(2)+ n*abs(e3)*x1(3)+n*abs(e4)*x1(4)+n*abs(e5)*x1(5)
w2 = w1 + n*abs(e1)*x2(1)+ n*abs(e2)*x2(2)+ n*abs(e3)*x2(3)+n*abs(e4)*x2(4)+n*abs(e5)*x2(5)
b = b + n*E;
%% 
